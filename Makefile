...
BuildExeForWindows:
	fyne-cross windows -arch=amd64 -ldflags="-X main.useInjectedEnvironmentVariables=true -X main.runInTray=true -X main.loggingLevel=DebugLevel -X main.executionConnectorPort=6672 -X main.executionLocationForConnector=LOCALHOST_NODOCKER -X main.executionLocationForWorker=GCP -X main.executionWorkerAddress=fenixexecutionworker-ca-must-be-logged-in-nwxrrpoxea-lz.a.run.app -X main.executionWorkerPort=443"
